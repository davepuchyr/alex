// kallisti http://hannibal:8131 Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; Trident/4.0; .NET CLR 1.1.4322)
// important
user_pref("browser.startup.page", 1);
user_pref("browser.startup.homepage", "http://dual.anoxymous.com/x/env?site=ebay.co.uk&whoami=kallisti");
user_pref("general.useragent.override", "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; Trident/4.0; .NET CLR 1.1.4322)");
user_pref("network.proxy.type", 1);
user_pref("network.proxy.ftp", "hannibal");
user_pref("network.proxy.ftp_port", 8131);
user_pref("network.proxy.gopher", "hannibal");
user_pref("network.proxy.gopher_port", 8131);
user_pref("network.proxy.http", "hannibal");
user_pref("network.proxy.http_port", 8131);
user_pref("network.proxy.share_proxy_settings", true);
user_pref("network.proxy.socks", "hannibal");
user_pref("network.proxy.socks_port", 8131);
user_pref("network.proxy.ssl", "hannibal");
user_pref("network.proxy.ssl_port", 8131);
// convenience
