// kgabertgoldmine2 http://hannibal:8150 
// important
user_pref("browser.startup.page", 1);
user_pref("browser.startup.homepage", "http://dual.anoxymous.com/x/env?site=&whoami=kgabertgoldmine2");
user_pref("general.useragent.override", "");
user_pref("network.proxy.type", 1);
user_pref("network.proxy.ftp", "hannibal");
user_pref("network.proxy.ftp_port", 8150);
user_pref("network.proxy.gopher", "hannibal");
user_pref("network.proxy.gopher_port", 8150);
user_pref("network.proxy.http", "hannibal");
user_pref("network.proxy.http_port", 8150);
user_pref("network.proxy.share_proxy_settings", true);
user_pref("network.proxy.socks", "hannibal");
user_pref("network.proxy.socks_port", 8150);
user_pref("network.proxy.ssl", "hannibal");
user_pref("network.proxy.ssl_port", 8150);
// convenience
